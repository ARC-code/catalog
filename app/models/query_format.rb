...
class QueryFormat
	...
	def self.catalog_format()
        ...
        'discipline' => { :name => 'Discipline', :param => :string, :default => nil, :transformation => get_proc(:transform_discipline)},
				...
				'role_ADI' => { :name => 'Art director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ADP' => { :name => 'Adapter', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_AFT' => { :name => ' etc.', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ANL' => { :name => 'Analyst', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ANM' => { :name => 'Animator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ANN' => { :name => 'Annotator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ANT' => { :name => 'Bibliographic antecedent', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_APE' => { :name => 'Appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_APL' => { :name => 'Appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_APP' => { :name => 'Applicant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_AQT' => { :name => 'Author in quotations or text abstracts', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ARC' => { :name => 'Architect', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ARD' => { :name => 'Artistic director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ARR' => { :name => 'Arranger', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ART' => { :name => 'Artist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ASG' => { :name => 'Assignee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ASN' => { :name => 'Associated name', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ATO' => { :name => 'Autographer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ATT' => { :name => 'Attributed name', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_AUC' => { :name => 'Auctioneer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_AUD' => { :name => 'Author of dialog', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_AUI' => { :name => ' etc.', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_AUS' => { :name => 'Screenwriter', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_AUT' => { :name => 'Author', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_BDD' => { :name => 'Binding designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_BJD' => { :name => 'Bookjacket designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_BLW' => { :name => 'Blurb writer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_BND' => { :name => 'Binder', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_BPD' => { :name => 'Bookplate designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_BRD' => { :name => 'Broadcaster', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_BRL' => { :name => 'Braille embosser', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_BSL' => { :name => 'Bookseller', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CAS' => { :name => 'Caster', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CCP' => { :name => 'Conceptor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CHR' => { :name => 'Choreographer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CLI' => { :name => 'Client', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_CLT' => { :name => 'Collotyper', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CMM' => { :name => 'Commentator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CMP' => { :name => 'Composer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_CNS' => { :name => 'Censor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_COE' => { :name => 'Contestant-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_CON' => { :name => 'Conservator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_COR' => { :name => 'Collection registrar', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_COS' => { :name => 'Contestant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_COT' => { :name => 'Contestant-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_COU' => { :name => 'Court governed', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_COV' => { :name => 'Cover designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CPC' => { :name => 'Copyright claimant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CPE' => { :name => 'Complainant-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CPH' => { :name => 'Copyright holder', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CPL' => { :name => 'Complainant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CPT' => { :name => 'Complainant-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CRE' => { :name => 'Creator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CRP' => { :name => 'Correspondent', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CRR' => { :name => 'Corrector', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CRT' => { :name => 'Court reporter', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CSL' => { :name => 'Consultant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CSP' => { :name => 'Consultant to a project', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CST' => { :name => 'Costume designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CTB' => { :name => 'Contributor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CTE' => { :name => 'Contestee-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CTG' => { :name => 'Cartographer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CTR' => { :name => 'Contractor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CTS' => { :name => 'Contestee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CTT' => { :name => 'Contestee-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CUR' => { :name => 'Curator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_CWT' => { :name => 'Commentator for written text', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DBP' => { :name => 'Distribution place', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DFD' => { :name => 'Defendant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DFE' => { :name => 'Defendant-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DFT' => { :name => 'Defendant-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DGG' => { :name => 'Degree granting institution', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DGS' => { :name => 'Degree supervisor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DIS' => { :name => 'Dissertant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DLN' => { :name => 'Delineator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DNC' => { :name => 'Dancer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DNR' => { :name => 'Donor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DPC' => { :name => 'Depicted', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DPT' => { :name => 'Depositor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DRM' => { :name => 'Draftsman', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DRT' => { :name => 'Director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DSR' => { :name => 'Designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DST' => { :name => 'Distributor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DTC' => { :name => 'Data contributor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DTE' => { :name => 'Dedicatee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DTM' => { :name => 'Data manager', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DTO' => { :name => 'Dedicator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_DUB' => { :name => 'Dubious author', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_EDC' => { :name => 'Editor of compilation', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_EDM' => { :name => 'Editor of moving image work', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_EDT' => { :name => 'Editor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_EGR' => { :name => 'Engraver', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ELG' => { :name => 'Electrician', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ELT' => { :name => 'Electrotyper', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ENG' => { :name => 'Engineer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ENJ' => { :name => 'Enacting jurisdiction', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ETR' => { :name => 'Etcher', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_EVP' => { :name => 'Event place', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_EXP' => { :name => 'Expert', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FAC' => { :name => 'Facsimilist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FDS' => { :name => 'Film distributor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FLD' => { :name => 'Field director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FLM' => { :name => 'Film editor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FMD' => { :name => 'Film director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FMK' => { :name => 'Filmmaker', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FMO' => { :name => 'Former owner', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FMP' => { :name => 'Film producer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FND' => { :name => 'Funder', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FPY' => { :name => 'First party', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_FRG' => { :name => 'Forger', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_GIS' => { :name => 'Geographic information specialist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_HIS' => { :name => 'Host institution', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_HNR' => { :name => 'Honoree', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_HST' => { :name => 'Host', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_INS' => { :name => 'Inscriber', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_INV' => { :name => 'Inventor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ISB' => { :name => 'Issuing body', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ITR' => { :name => 'Instrumentalist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_JUD' => { :name => 'Judge', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_JUG' => { :name => 'Jurisdiction governed', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LBR' => { :name => 'Laboratory', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LBT' => { :name => 'Librettist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LDR' => { :name => 'Laboratory director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LED' => { :name => 'Lead', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LEE' => { :name => 'Libelee-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LEL' => { :name => 'Libelee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LEN' => { :name => 'Lender', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LET' => { :name => 'Libelee-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LGD' => { :name => 'Lighting designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LIE' => { :name => 'Libelant-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LIL' => { :name => 'Libelant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LIT' => { :name => 'Libelant-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LSA' => { :name => 'Landscape architect', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LSE' => { :name => 'Licensee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LSO' => { :name => 'Licensor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LTG' => { :name => 'Lithographer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_LYR' => { :name => 'Lyricist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MCP' => { :name => 'Music copyist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MDC' => { :name => 'Metadata contact', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MED' => { :name => 'Medium', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MFP' => { :name => 'Manufacture place', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MFR' => { :name => 'Manufacturer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MOD' => { :name => 'Moderator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MON' => { :name => 'Monitor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MRB' => { :name => 'Marbler', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MRK' => { :name => 'Markup editor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MSD' => { :name => 'Musical director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MTE' => { :name => 'Metal-engraver', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MTK' => { :name => 'Minute taker', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_MUS' => { :name => 'Musician', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_NRT' => { :name => 'Narrator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_OPN' => { :name => 'Opponent', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ORG' => { :name => 'Originator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_ORM' => { :name => 'Organizer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_OSP' => { :name => 'Onscreen presenter', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_OTH' => { :name => 'Other', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_OWN' => { :name => 'Owner', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PAN' => { :name => 'Panelist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PAT' => { :name => 'Patron', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PBD' => { :name => 'Publishing director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PBL' => { :name => 'Publisher', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PDR' => { :name => 'Project director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PFR' => { :name => 'Proofreader', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PHT' => { :name => 'Photographer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PLT' => { :name => 'Platemaker', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PMA' => { :name => 'Permitting agency', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PMN' => { :name => 'Production manager', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_POP' => { :name => 'Printer of plates', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PPM' => { :name => 'Papermaker', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PPT' => { :name => 'Puppeteer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRA' => { :name => 'Praeses', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRC' => { :name => 'Process contact', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRD' => { :name => 'Production personnel', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRE' => { :name => 'Presenter', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRF' => { :name => 'Performer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRG' => { :name => 'Programmer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_PRP' => { :name => 'Production place', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRS' => { :name => 'Production designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRT' => { :name => 'Printer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PRV' => { :name => 'Provider', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PTA' => { :name => 'Patent applicant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PTE' => { :name => 'Plaintiff-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PTF' => { :name => 'Plaintiff', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PTH' => { :name => 'Patent holder', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PTT' => { :name => 'Plaintiff-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_PUP' => { :name => 'Publication place', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RBR' => { :name => 'Rubricator', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RCD' => { :name => 'Recordist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RCE' => { :name => 'Recording engineer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RCP' => { :name => 'Addressee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RDD' => { :name => 'Radio director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RED' => { :name => 'Redaktor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_REN' => { :name => 'Renderer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RES' => { :name => 'Researcher', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_REV' => { :name => 'Reviewer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RPC' => { :name => 'Radio producer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RPS' => { :name => 'Repository', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RPT' => { :name => 'Reporter', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RPY' => { :name => 'Responsible party', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RSE' => { :name => 'Respondent-appellee', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RSG' => { :name => 'Restager', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RSP' => { :name => 'Respondent', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RSR' => { :name => 'Restorationist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RST' => { :name => 'Respondent-appellant', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RTH' => { :name => 'Research team head', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_RTM' => { :name => 'Research team member', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SAD' => { :name => 'Scientific advisor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SCE' => { :name => 'Scenarist', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_SDS' => { :name => 'Sound designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SEC' => { :name => 'Secretary', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SGD' => { :name => 'Stage director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SGN' => { :name => 'Signer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SHT' => { :name => 'Supporting host', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SLL' => { :name => 'Seller', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SNG' => { :name => 'Singer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SPK' => { :name => 'Speaker', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SPN' => { :name => 'Sponsor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SPY' => { :name => 'Second party', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_SRV' => { :name => 'Surveyor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_STD' => { :name => 'Set designer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_STG' => { :name => 'Setting', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_STL' => { :name => 'Storyteller', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_STM' => { :name => 'Stage manager', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_STN' => { :name => 'Standards body', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_STR' => { :name => 'Stereotyper', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_TCD' => { :name => 'Technical director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_TCH' => { :name => 'Teacher', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_THS' => { :name => 'Thesis advisor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_TLD' => { :name => 'Television director', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_TLP' => { :name => 'Television producer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_TRC' => { :name => 'Transcriber', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				...
				'role_UVP' => { :name => 'University place', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_VAC' => { :name => 'Voice actor', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_VDG' => { :name => 'Videographer', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WAC' => { :name => 'Writer of added commentary', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WAL' => { :name => 'Writer of added lyrics', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WAM' => { :name => 'Writer of accompanying material', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WAT' => { :name => 'Writer of added text', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WDC' => { :name => 'Woodcutter', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WDE' => { :name => 'Wood engraver', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WIN' => { :name => 'Writer of introduction', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WIT' => { :name => 'Witness', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WPR' => { :name => 'Writer of preface', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
				'role_WST' => { :name => 'Writer of supplementary textual content', :param => :string, :default => nil, :transformation => get_proc(:transform_role_generic)},
  ...
  def self.languages_format()
	...
	def self.exhibit_format()
		format = {
			...
			'edition_year' => { :name => 'edition_year', :param => :string, :default => nil, :transformation => get_proc(:transform_field), :can_be_array => true },
